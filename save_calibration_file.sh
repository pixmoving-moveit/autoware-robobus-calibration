...
cat<<EOF
a: robobus lidar_front_base_link 到 lidar_fl_base_link,lidar_fr_base_link,lidar_rear_base_link
...
case "$choice" in
    a)
        parent_frame='lidar_front_base_link'
        child_frame='[lidar_fl_base_link,lidar_fr_base_link,lidar_rear_base_link]'
